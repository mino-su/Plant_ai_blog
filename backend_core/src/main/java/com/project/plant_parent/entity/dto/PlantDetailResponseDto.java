...
public class PlantDetailResponseDto {
    ...
    private class ItemDto{
        ...
        @JacksonXmlProperty(localName = "clCodeNm")// [식용, 지피, 약용, 향기,관엽, 관화, 관실]
        private String clCodeNm;

        @JacksonXmlProperty(localName = "distbNm")//[잎&꽃보기식물,열매보기식물]
        private String distbNm;

        @JacksonXmlProperty(localName = "dlthtsCodeNm")// [파스향나무 (추천 유통명: 가울테리아)]
        private String dlthtsCodeNm;

        @JacksonXmlProperty(localName = "fncltyInfo")// [응애,깍지벌레]
        private String fncltyInfo;

        @JacksonXmlProperty(localName = "adviseInfo")//[진달래과의 작은 관목으로 척박한 산성토양에서 잘 자라며 키는 20cm정도로 포복형이다.  암석정원에 잘 어울린다.]
